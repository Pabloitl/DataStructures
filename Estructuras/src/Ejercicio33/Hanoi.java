/**
 * Programa que ilustra graficamente el uso de pilas al ir mostrando la solución.
 * El juego consiste en tener en un palo A, n discos de diferente tamaño de mayor a menor y pasarlos
 * a un palo B usando un disco auxiliar C, con la restricción que ningún
 * disco de tamaño mayor puede colocarse sobre uno menor.
